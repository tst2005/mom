...
local setfenv = setfenv or require"compat_env".setfenv
...
local function run(implementation)
	...
	common = type(require(implementation))=="table" and require(implementation).common or require"i":need(implementation)
	--count the attempts
	local failed = 0
	local attempts = 0
	--run all tests
